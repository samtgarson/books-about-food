      ...
      <>
        ...
        <Row>
          <Column className="bg-white p-6 pt-0">
            <Text className="font-medium">Re: {resourceName}</Text>
            <Text className="italic p-4 border border-solid border-grey">
              {suggestion}
            </Text>
            <Button href={url}>Edit {resourceType} in Forest</Button>
          </Column>
        </Row>
      </>
    )
